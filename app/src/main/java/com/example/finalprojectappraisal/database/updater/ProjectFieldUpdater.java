...
public final class ProjectFieldUpdater {
    ...
    public static void updatePropertyFields(Project project, Map<String, Object> propertyDetails) {
        ...
        updateIntegerField(project::setNumberOfFloors, propertyDetails, FirestoreConstants.FIELD_NUMBER_OF_FLOORS);
    }
    ...
    public static void updateApartmentFields(Project project, Map<String, Object> apartmentDetails) {
        ...
        updateIntegerField(project::setFloorNumber, apartmentDetails, FirestoreConstants.FIELD_FLOOR_NUMBER);
        updateDoubleField(project::setNumberOfRooms, apartmentDetails, FirestoreConstants.FIELD_NUMBER_OF_ROOMS);
        updateDoubleField(project::setRegisteredArea, apartmentDetails, FirestoreConstants.FIELD_REGISTERED_AREA);
        updateDoubleField(project::setGrossArea, apartmentDetails, FirestoreConstants.FIELD_GROSS_AREA);
    }
    ...
    public static void updateFeatureFields(Project project, Map<String, Object> features) {
        ...
        updateBooleanField(project::setHasAirConditioning, features, FirestoreConstants.FIELD_HAS_AIR_CONDITIONING);
