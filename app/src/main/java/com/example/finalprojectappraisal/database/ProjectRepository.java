                ...
                .addOnSuccessListener(querySnapshot -> {
                    ...
                    for (DocumentSnapshot document : querySnapshot.getDocuments()) {
                        try {
                            ...
                            // Log individual project loading errors but continue with others
                            System.err.println("Error loading project " + document.getId() + ": " + e.getMessage());
                        }
                    }
                    allProjects.setValue(projects);
                })
                .addOnFailureListener(e -> errorMessage.setValue(FirestoreConstants.ERROR_LOADING_PROJECTS + ": " + e.getMessage()));
    }
